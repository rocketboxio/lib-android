...
public class AsyncSetValue extends AsyncTask<String, Void, JSONObject> {
	...
	protected JSONObject doInBackground(String... params) {
		...
		try {
			...
			parameters.add(new BasicNameValuePair("key", params[1]));
			parameters.add(new BasicNameValuePair("value", params[2]));
